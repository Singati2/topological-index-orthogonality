...
reduces to, on three standard testbeds: the $18$ octane isomers
(five NIST physicochemical properties), the $106$ non-isomorphic
trees of order $10$, and the $75$ decane isomers. The comparison set
...
non-isomorphic graphs; lower is better. On the $106$ non-isomorphic
...
As self-contained dispersion measures over the $75$ decane isomers
we report the coefficient of variation $SS = \sigma/\mu$, the
