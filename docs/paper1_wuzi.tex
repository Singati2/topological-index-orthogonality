...
A companion methodology paper~\cite{Paper2_Screening} studies
multi-dataset redundancy screening of topological indices. The
present paper is concerned only with the sensitivity of the Wuzi
family on the three classical compound classes listed above.
...
still be multivariately redundant with the classical baseline. A
...
subspace on $\mathcal{G}_4$. A companion methodology
paper~\cite{Paper2_Screening} studies multi-dataset redundancy
screening of topological indices.
