...
bound, are stated as Conjectures~\ref{conj:GA}, \ref{conj:H_ABC},
...
Conjectures~\ref{conj:GA} and~\ref{conj:H_ABC} state target bounds
...
\begin{conjecture}[Bounds via harmonic $H$ and $ABC$]\label{conj:H_ABC}
...
(Conjectures~\ref{conj:GA}, \ref{conj:H_ABC}).
...
(Conjectures~\ref{conj:NG}, \ref{conj:GA}, \ref{conj:H_ABC}), as do
